...
## Analise
- Hipotese 1: sustentada pela reproducao do usuario. O clique em `Pagar` nao chegou ao `onSubmit`.
- Hipotese 2: ainda nao confirmada; sem evidencia de entrada em `submitCardPayment`.
- Hipotese 3: rejeitada por enquanto; nao ha evidencia de requisicao ao backend.
...
## Status
- Correcao aplicada; aguardando reteste do usuario.
